...
import { DataForSeoSetupCard, ModuleDisabledCard } from "./DataForSeoSetupCard";
          ...
          <>
            ...
            >
              <div className="flex flex-col gap-2">
                ...
                <p className="px-1 text-[13px] text-base-content/45">
                  Scans usually finish in 30 seconds to 3 minutes. Uses
                  DataForSEO on-page credits from your configured key.
                </p>
              </div>
            </form>
            ...
            {view?.status === "failed" && (
              <div className="alert alert-error text-sm">
                {view.error ?? "The scan failed. Please try again."}
              </div>
            )}
